...
import com.fivek.userapp.databinding.ActivityServiceDetailsBinding
import com.fivek.userapp.ui.BaseActivity
import com.fivek.userapp.ui.cart.CartListActivity
import com.fivek.userapp.ui.serviceDetails.adapter.RatingListAdapter
import com.fivek.userapp.ui.serviceDetails.adapter.ServiceIncludedAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.addCartView.setOnClickListener {
            CarCareApplication.instance.applicationScope.launch {
                val cart = CartModelData(serviceDetailsResponse.data.id, serviceDetailsResponse.data.name, serviceDetailsResponse.data.banner, serviceDetailsResponse.data.elite,serviceDetailsResponse.data.actual, serviceDetailsResponse.data.offer)
                CarCareApplication.instance.applicationScope.launch {
