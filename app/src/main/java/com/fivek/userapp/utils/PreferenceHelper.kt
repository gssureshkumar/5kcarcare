...
class PreferenceHelper(context: Context) {
    ...
    var intCityNamePref: String?
        get() = preferences.getString(CITY_NAME, "")
        set(value) = preferences.edit().putString(CITY_NAME, value).apply()

    var intStateNamePref: String?
        get() = preferences.getString(STATE_NAME, "")
        set(value) = preferences.edit().putString(STATE_NAME, value).apply()
